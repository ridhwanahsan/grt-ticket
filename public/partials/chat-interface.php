		...
		<div id="grt-tab-tickets" class="grt-tab-content active">
			...
			<div class="grt-direct-contact-actions">
				<?php if ( $enable_direct_call ) : ?>
					<a href="<?php echo esc_url( 'tel:' . $support_phone ); ?>" class="grt-action-btn grt-call-btn">
						<span class="grt-icon">📞</span> <?php esc_html_e( 'Call Us', 'grt-ticket' ); ?>
					</a>
				<?php endif; ?>
				
				<?php if ( $enable_direct_sms ) : 
					$sms_url = 'sms:' . $support_phone . '?body=' . rawurlencode( $sms_body );
				?>
					<a href="<?php echo esc_url( $sms_url ); ?>" class="grt-action-btn grt-sms-btn">
			...
			<div class="grt-chat-header-right">
				<?php if ( ( $enable_direct_call || $enable_direct_sms ) && ! empty( $support_phone ) ) : ?>
					<div class="grt-direct-contact-header">
						<?php if ( $enable_direct_call ) : ?>
							<a href="<?php echo esc_url( 'tel:' . $support_phone ); ?>" class="grt-action-btn grt-call-btn" title="<?php esc_attr_e( 'Call Us', 'grt-ticket' ); ?>">
						...
						<?php if ( $enable_direct_sms ) : 
							$sms_url = 'sms:' . $support_phone . '?body=' . rawurlencode( $sms_body );
						?>
							<a href="<?php echo esc_url( $sms_url ); ?>" class="grt-action-btn grt-sms-btn" title="<?php esc_attr_e( 'SMS Us', 'grt-ticket' ); ?>">
